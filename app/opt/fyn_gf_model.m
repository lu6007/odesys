...
function model_obj = fyn_gf_model(model_name, varargin)
    ...
    model_obj.opt.index = 3; % [egf] = 50 ng/ml %[3; 5; 6] % 50, 10, 5
    model_obj.opt.theta_name = {'kon_4'; 'koff_4'; 'kcaton_7'; 'kdon_7'; ...
        'kcatoff_7'; 'kdoff_7'};
    model_obj.opt.theta_upper_bound = [10; 1; 1; 500; 1; 500]; 
...
%     kcaton9 = data.kcat_on_7;
%     kdon9 = data.kd_on_7;
%     vmaxoff9 = data.kcat_off_7*ptp_act;
%     vmaxoff9 = data.vmaxoff9*ptp_act;
%     kmoff9 = data.kd_off_7;
